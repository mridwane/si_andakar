        ...
        <section class="food_section layout_padding" id="pilihMenu">
            <div class="container">
                ...
                <div class="filters-content">
                    <div class="row grid">
                        <?php
                        $query = "SELECT * FROM tblproducts a Join tblcategory b WHERE a.category_id = b.category_id AND
                        NOT b.category = 'Saus'";
                                ...
                                <div class="box">
                                    <div>
                                        ...
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                <h3> <b> Rp. <?= number_format($row['price'], 0, ',', '.'); ?> </b>
                                                </h3>
                                                <?php if ($row['status'] == "Tersedia") { ?>
                                                    <a href="#" class="add-to-cart" data-kode="<?= $row['product_id'] ?>" data-name="<?= $row['product_name'] ?>" data-price="<?= $row['price'] ?>">
