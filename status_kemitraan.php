...
$query2 = 'SELECT * FROM `tblbuktitransfer`  WHERE no_transac = "' . $regis_no . '"';
                            ...
                            <div class="form_container">
                                <form action="controller/kemitraan_controller.php" method="POST" enctype="multipart/form-data">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="transac_code" value="<?= $regis_no ?>" readonly />
                                    </div>
                                    ...
                                    <?php } elseif ($status == "active") { ?>
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="transac_code" value="<?= $status ?>" readonly />
                                        </div>
                                        <span><b>Sekarang anda tergabung dalam mitra kami. Download <a href="controller/download_file_transaksi.php?file_name=<?php echo $file_name ?>&no_transac=<?php echo $regis_no ?>">BUKTI PEMBAYARAN
                                                </a> kemitraan kamu </b></span>
