            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <form action="controller/delivery_controller.php?action=savetrfrvslns" method="POST"
                            ...
                            <div>
                                <span>
                                    <b>*silahkan melakukan pembayaran ke rekening <b>BANK BCA (525 019 1873) atas nama
                                            Yanuar R. Arief</b> sesuai dengan Jumlah total bayar.
                                    </b>
                                </span>
