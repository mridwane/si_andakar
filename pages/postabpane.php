                                      ...
                                      ?>
					                                <div class="col-sm-4 col-md-2">
					                                    <form method="post"
					                                        action="pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
					                                        <div class="products bg-info text-white">
					                                            ...
					                                            <input type="submit" name="addpos" style="margin-top:5px;"
					                                                class="btn btn-block btn-warning btn-block" value="Add Menu" />
					                                        </div>
					                                    </form>
					                                </div>
					                                <?php endwhile; ?>
					                                    ...
					                                    <form method="post"
					                                        ...
					                                        <div class="products bg-info text-white">
					                                            ...
					                                            <input type="hidden" name="price"
					                                                value="<?php echo $product['PRICE']; ?>" />
					                                            <input type="submit" name="addpos" style="margin-top:5px;"
					                                                class="btn btn-block btn-warning" value="Add Menu" />
					                                        </div>
					                                    </form>
					                                </div>
					                                <?php endwhile;
