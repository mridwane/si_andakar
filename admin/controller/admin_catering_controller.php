    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div style="clear:both;"></div>
                <div class="modal-footer">
                    <button type="submit" name="save_deny" id="save_deny" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span>Simpan</button>
                    <button class="btn btn-danger" type="button" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                </div>
        </div>
        </form>
...
<div class="modal fade" id="dp_modal<?php echo $_GET['id']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="controller/admin_catering_controller.php?no_transac=<?php echo $_GET['id']; ?>&action=dp">
                <div class="modal-header">
...
<div class="modal fade" id="accept_modal<?php echo $_GET['id']; ?>" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="controller/admin_catering_controller.php?no_transac=<?php echo $_GET['id']; ?>&action=accept">
                <div class="modal-header">
...
<script type="text/javascript">
    window.location.href = '../detailtransac.php?id=<?php echo $no_transac ?>';
    alert("Pesanan Catering Selesai. Silahkan Cetak Invoice.");
</script>
<?php
