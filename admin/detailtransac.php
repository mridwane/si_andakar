      ...
      <div style="margin-bottom: 30px">
        ...
        <?php if (strtoupper($order_type) == strtoupper("delivery") || strtoupper($order_type) == strtoupper("catering")) { ?>
          <?php if ($stats == "paid" || $stats == "dp" || $stats == "lunas" || $stats == "pelunasan" || $stats == "after_revision_lns" || $stats == "after_revision") { ?>
            <p>Bukti Transfer <?php if ($order_type == "Catering") {
                                  echo " DP";
                                } ?>:
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          ...
          <?php
                ...
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon1">BIAYA SERVICE 5% : </span>
                  </div>
                  <input type="text" class="form-control" value="Rp. <?= number_format($service); ?>" readonly>
                </div>
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                ...
                <?php } elseif ($stats == "lunas") {?>
                  ...
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">PELUNASAN YANG DIBAYAR : </span>
                    </div>
                    <input type="text" class="form-control" value="Rp. <?= number_format($sisa); ?>" readonly>
                  </div>
                  <div class="input-group mb-3">
                ...
                <?php } elseif ($stats == "done") { ?>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" value="Rp. <?= number_format($pelunasan); ?>" readonly>
                  </div>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1">SISA PEMBAYARAN : </span>
                    </div>
                    <input type="text" class="form-control" value="Rp. <?= number_format($total_pembayaran - $total); ?>" readonly>
                  </div>
                <?php } ?>
         ...
         <a title="confirmdelivery" type="button" class="btn btn-xs btn-success"
          ...
          <?php } elseif (strtoupper($row["status"]) == strtoupper("dp") || strtoupper($row["status"]) == strtoupper("after_revision") && strtoupper($row["transac_type"]) == strtoupper("catering")) { ?>
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#dp_modal<?php echo $_GET['id']; ?>">Terima Pesanan</button>
