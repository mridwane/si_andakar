...
?>
      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
            ...
            <tr>
              <td align="center" width="20%"><b style="font-size: 30px">Admin Nama: </b></td>
        ...
        <br>
         <tr>
              <td align="center" width="20%"><b style="font-size: 30px">Nama Pengguna: </b></td>
              <td align="center" width="20%">
        ...
        <br>
         <tr>
              <td align="center" width="20%"><b style="font-size: 30px">Posisi: </b></td>
              <td align="center" width="20%">
