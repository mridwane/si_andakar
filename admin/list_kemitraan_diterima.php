            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                            $query = 'SELECT * ,concat(b.`c_fname`," ",b.`c_lname`)as name FROM tblrequestmitra a inner join tblcustomer b on a.`c_id` = b.`c_id` WHERE b.`C_AKSES` = "Mitra" AND a.`status` = "active" OR a.`status` = "nonactive"';
