                                ...
                                <div class="detail-box">
                                    ...
                                    <div class="options">
                                        <select name="" id="" class="form-control nice-select wide">
                                            ...
                                            <?php   
                                                $query2 = "SELECT * FROM tblproducts a Join tblcategory b WHERE
                                                a.category_id = b.category_id AND b.category = 'Saus'";
                                                $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
                                                while ($item = mysqli_fetch_assoc($result2)) { 
                                            ?>
                                            <option value="<?= $item['product_name'] ?>"><?= $item['product_name'] ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Makanan Yang Dipesan</h5>
